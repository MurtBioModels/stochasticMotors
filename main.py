...
2. CHECK Try two objects moving apart, without force calculated by bead location, then you know if it's the bead, and not the event drawing and/or motor order bias (maybe still calculate if it's an unbiased coin, with both retro and antero motor first in list)
