...
## Simulation settings ##
#dirct1 = '20221201_173847_elastic_coupling_allbound_fex4_7'
#dirct2 = '20221201_151454_elastic_coupling_fex_allbound'
#dirct3 = '20221223_102253_elastic_coupling_large_endtime'
dirct4 = '20230103_112142_elastic_coupling_no_endtime'
tslist = [3, 4]
kmlist = [0.02, 0.04, 0.08, 0.1, 0.2] # HAS TO BE THE RIGHT ORDER!!!!
#fexlist = [-4, -5, -6, -7]
fexlist = [-1, -2, -3, 0]
...
#df.xm_n_fex_km(dirct=dirct4, filename='', ts_list=tslist, fex_list=fexlist, km_list=kmlist, stepsize=0.01)
