...
from analysis_plotting import print_info as pi
...
#pi.check_rl_singlemotor(dirct=dirct1)
...
ir.plot_n_fex_km_rl_log(dirct=dirct1, filename='rl_cargo_N_fex_km_csv', n_include=tslist, fex_include=fexlist, km_include=kmlist, show=False)
...
ir.plot_n_fex_km_xb_cdf(dirct=dirct1, filename='xb_sampled_.csv', n_include=tslist, fex_include=fexlist, km_include=kmlist, show=False, figname='')
...
ir.plot_fex_N_km_forces_motors_cdf(dirct=dirct1, filename='motorforces_N_fex_km_.csv', n_include=tslist, fex_include=fexlist, km_include=kmlist, show=False, figname='')
ir.plot_fex_N_km_forces_motors_violin(dirct=dirct1, filename='motorforces_N_fex_km_.csv', n_include=tslist, fex_include=fexlist, km_include=kmlist, show=False, figname='')

# motor displacement
ir.xm_n_fex_km(dirct=dirct1, ts_list=tslist, fex_list=fexlist, km_list=kmlist, stepsize=0.01, samplesize=100, filename='')
ir.plot_fex_N_km_xm(dirct=dirct1, filename='xm_N_fex_km_.csv', n_include=tslist, fex_include=fexlist, km_include=kmlist, stat='probability', show=False, figname='')

# motor runlengths
ir.rl_motors_n_fex_km(dirct=dirct1, ts_list=tslist, fex_list=fexlist, km_list=kmlist, filename='')
ir.plot_fex_N_km_rl_motors(dirct=dirct1, filename='rlmotors_N_fex_km_.csv', n_include=tslist, fex_include=fexlist, km_include=kmlist, show=False, figname='')
